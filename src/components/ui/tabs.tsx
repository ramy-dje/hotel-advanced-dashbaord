...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "relative inline-flex items-center justify-center whitespace-nowrap py-4 text-sm font-medium transition-colors hover:text-foreground focus-visible:outline-none focus-visible:!text-primary focus-visible:before:!bg-primary disabled:pointer-events-none disabled:opacity-50 text-foreground/60 data-[state=active]:text-foreground",
      "data-[state=active]:before:bg-foreground data-[state=active]:before:absolute data-[state=active]:before:bottom-0 data-[state=active]:before:left-0 data-[state=active]:before:z-[1] data-[state=active]:before:h-0.5 data-[state=active]:before:w-full",
      className
    )}
    {...props}
  />
