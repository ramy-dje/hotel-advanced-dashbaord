...
export type SystemPermissions =
  ...
  // property_directory (subject) : actions
  | "property_directory:create"
  | "property_directory:update"
  | "property_directory:delete"
  | "property_directory:read"

  // property_type (subject) : actions
