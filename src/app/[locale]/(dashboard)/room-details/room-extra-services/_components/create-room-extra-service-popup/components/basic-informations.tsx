    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-[auto,1fr] gap-4">
        ...
        <div className="flex flex-col gap-2">
          ...
          <Input
            disabled={isLoading}
            id="name"
            placeholder="set the service name"
      ...
      <div className="flex flex-col gap-2">
        ...
        <Textarea
          disabled={isLoading}
          id="description"
          placeholder="Set the service description"
      ...
      <div className="">
        ...
        <Select value={watch("category")} onValueChange={(value) => setValue("category", value)}>
          ...
          <SelectContent>
            {existingCategories.map((category:any,index:number) => (
      ...
      <div className="flex flex-col gap-2">
        ...
        <Input
          disabled={isLoading}
          id="property_code"
          placeholder="Set the property code"
