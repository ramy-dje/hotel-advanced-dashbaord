...
export const UpdateRoomExtraServiceValidationSchema = z
  .object({
    /* Basic Informations */
    ...
    /*pricing */
    service_availability: z
      .string()
      .min(1, "The service availability is required"),
...
export type UpdateRoomExtraServiceValidationSchemaType = z.infer<
  typeof UpdateRoomExtraServiceValidationSchema
>;
