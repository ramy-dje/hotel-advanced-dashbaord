...
// Update Room Images Section

interface Props {
  id: string;
}

const UpdateRoom_Images_Section = forwardRef<HTMLDivElement, Props>(
  ({ id }, ref) => {
...
UpdateRoom_Images_Section.displayName = "UpdateRoom_Images_Section";

export default UpdateRoom_Images_Section;
