...
// Update Room SEO Section

interface Props {
  id: string;
}

const UpdateRoom_SEO_Section = forwardRef<HTMLDivElement, Props>(
  ({ id }, ref) => {
    const {
    ...
    useEffect(() => {
      if (name_controller.field.value) {
        ...
        setValue("seo_title", name_controller.field.value);
      }
...
export default UpdateRoom_SEO_Section;
