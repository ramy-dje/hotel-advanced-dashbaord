...
export const UpdateBedValidationSchema = z
  .object({
    // main info section
    ...
    // to set old
    old_name: z.string().optional().nullable(),
...
export type UpdateRoomValidationSchemaType = z.infer<
  typeof UpdateBedValidationSchema
>;
