...
import CreateApartmentFrom from "./_components/create-form";
    ...
    <>
      ...
      <PageLayout>
          ...
          <PageLayoutHeaderNameAndBreadcrumbs>
            ...
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbItem>
                  <BreadcrumbLink asChild>
                    <Link href="/rooms">Apartments</Link>
                  </BreadcrumbLink>
                </BreadcrumbItem>
                <BreadcrumbSeparator
                  children={
                ...
                />
                <BreadcrumbItem>
                  <BreadcrumbPage>Create Apartment</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </PageLayoutHeaderNameAndBreadcrumbs>
        ...
        {isFetchingData ? (
          ...
          <CreateApartmentFrom formSelectData={roomFeaturesFormData} />
        )}
      </PageLayout>
    </>
  );
