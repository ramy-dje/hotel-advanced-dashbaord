...
// Create Dish category & ingredients Section
...
const CreateDish_TypeAndIngredients_Section = forwardRef<HTMLDivElement, Props>(
  ({ id, formData }, ref) => {
    const {
        ...
        <CreationFormSectionContent>
          ...
          <div className="flex flex-col col-span-2 md:col-span-1 gap-2">
            ...
            <Select
              ...
              onValueChange={(e) =>
                type_controller.field.onChange(e == "null" ? null : e)
              }
            >
...
export default CreateDish_TypeAndIngredients_Section;
