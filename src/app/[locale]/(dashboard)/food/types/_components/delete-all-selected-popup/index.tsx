...
import { crud_delete_many_food_types } from "@/lib/curd/food-type";
...
export default function DeleteAllSelectedFoodTypesPopup({
  selectedIds,
  unSelectedAll,
}: Props) {
  // food types store hook
  const { remove_many_types } = useFoodTypesStore();
  ...
  const handleDelete = async () => {
    ...
    try {
      // delete many tag
      const res = await crud_delete_many_food_types(selectedIds);
