...
import CreatePropertyTypePopup, { AddPricingModal } from "./_components/pricing-popup";
import SetPricingPopup from "./_components/pricing-popup";
      ...
      <CreationFormSection ref={ref} id={id}>
        ...
        <CreationFormSectionContent>
          ...
          <SetPricingPopup
            ...
            onSave={()=>{}}
            roomTypes={[]}
            disabled={false} // or true to disable Save button
          />
