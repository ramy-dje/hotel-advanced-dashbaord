...
// Create blog categories and tags Section
...
const CreateBlog_TagsAndCategories_Section = forwardRef<HTMLDivElement, Props>(
  ({ id, formData }, ref) => {
    const {
...
export default CreateBlog_TagsAndCategories_Section;
