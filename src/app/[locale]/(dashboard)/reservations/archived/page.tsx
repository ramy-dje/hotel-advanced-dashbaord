...
import TrashedReservationsTable from "./_components/table";
import ViewTrashedReservationSheet from "./_components/reservations-view/sheet";
  ...
  return (
    <>
      ...
      <PageLayout>
        ...
        <TrashedReservationsTable meta={{ handleViewReservation, has }} />
      </PageLayout>
    </>
  );
}
