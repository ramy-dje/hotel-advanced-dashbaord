...
import { z } from "zod";
// Create reservation zod validation schema

export const CreateReservationValidationSchema = z
  .object({
    // person data
    person_fullName: z
      .string()
...
export type CreateReservationValidationSchemaType = z.infer<
  typeof CreateReservationValidationSchema
>;
