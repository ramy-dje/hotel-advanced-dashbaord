...
import { UpdateReservationValidationSchemaType } from "./update-form.schema";
...
interface Props {
  control: Control<UpdateReservationValidationSchemaType>;
  room: RoomInterface | null;
}

// The Priding part in the create reservation form

export default function CreateReservationPricing({ control, room }: Props) {
