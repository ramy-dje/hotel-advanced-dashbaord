import { z } from "zod";
// Update reservation zod validation schema

export const UpdateReservationValidationSchema = z
  .object({
    // person data
    person_fullName: z
      .string()
...
export type UpdateReservationValidationSchemaType = z.infer<
  typeof UpdateReservationValidationSchema
>;
