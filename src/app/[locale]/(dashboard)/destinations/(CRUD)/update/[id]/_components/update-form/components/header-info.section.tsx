...
// Update Destination header Info Section

interface Props {
  id: string;
}

const UpdateDestination_HeaderInfo_Section = forwardRef<HTMLDivElement, Props>(
  ({ id }, ref) => {
    const {
...
export default UpdateDestination_HeaderInfo_Section;
