...
// Create Destination content Section

interface Props {
  id: string;
}

const CreateDestination_Content_Section = forwardRef<HTMLDivElement, Props>(
  ({ id }, ref) => {
    const {
      control,
...
export default CreateDestination_Content_Section;
