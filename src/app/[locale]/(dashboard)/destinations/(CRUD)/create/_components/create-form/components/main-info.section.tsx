...
// Create Destination Main Info Section

interface Props {
  id: string;
}

const CreateDestination_MainInformation_Section = forwardRef<
  HTMLDivElement,
  Props
>(({ id }, ref) => {
  const {
...
export default CreateDestination_MainInformation_Section;
