...
import { crud_delete_many_rate_categories } from "@/lib/curd/rate-category";
...
export default function DeleteAllSelectedRatePlanCategoriesPopup({
  selectedIds,
  unSelectedAll,
}: Props) {
  // rooms store
  const { remove_many_categories } = useRatePlanCategoriesStore();
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const res = await crud_delete_many_rate_categories(selectedIds);
