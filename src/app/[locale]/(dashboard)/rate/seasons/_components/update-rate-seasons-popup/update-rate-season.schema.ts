import { z } from "zod";
// update rate season zod validation schema

export const UpdateRateSeasonValidationSchema = z
.object({
...
export type UpdateRateSeasonValidationSchemaType = z.infer<
  typeof UpdateRateSeasonValidationSchema
>;
