...
const UpdateOffers_BuyXGetY_Section = () => {
  const {
  ...
  const offerType = useSearchParams().get(
    "offerType",
  ) as UpdateOffersValidationSchemaType["type"];
      ...
      <CreationFormSectionContent className="xl:col-span-full p-3 shadow-md border border-gray-200 rounded-md">
        ...
        >
          ...
          {watch("bxgy.discountType") === "percentage" && (
           <Input
              type="number"
              min={0}
              placeholder="Set the percentage"
              disabled={disabled}
          ...
          {watch("bxgy.discountType") === "fixed" && (
           <Input
              type="number"
              min={0}
              placeholder="Set the fixed amount"
              disabled={disabled}
              {...register("bxgy.discountValue", {
                setValueAs: (value) =>
                  value === "" ? undefined : Number(value),
        ...
        <div className="flex flex-row col-span-2 w-full gap-4">
          <Checkbox
            ...
            onCheckedChange={(checked: boolean) =>
              setValue("bxgy.hasMaxUsage", checked)
            }
          />
        ...
        {watch("bxgy.hasMaxUsage") && (
          <Input
            type="number"
            min={0}
            placeholder="Set maximum number of uses"
            disabled={disabled}
...
export default UpdateOffers_BuyXGetY_Section;
