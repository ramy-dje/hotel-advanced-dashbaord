...
const CreateOffers_valid_from_to_Section = () => {
  const {
    ...
    <CreationFormSection>
      <CreationFormSectionContent className="xl:col-span-full p-3 shadow-md border border-gray-200 rounded-md">
        ...
        <div className="flex flex-row col-span-2 w-full gap-2">
          <Checkbox 
            id="hasEndDate"
            checked={getValues("timeValidity.hasEndDate")}
            onCheckedChange={(checked :boolean) => setValue("timeValidity.hasEndDate", checked)}
          />
...
export default CreateOffers_valid_from_to_Section;
