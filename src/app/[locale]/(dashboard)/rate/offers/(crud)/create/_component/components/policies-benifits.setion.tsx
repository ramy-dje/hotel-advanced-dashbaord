...
const CreateOffer_Policies_Benifits_Section = () => {
  const {
  ...
  return (
    <CreationFormSection>
      <CreationFormSectionContent className="overflow-x-auto xl:col-span-full p-3 shadow-md border border-gray-200 rounded-md">
        <h1 className="text-lg font-semibold">Policies & Benifits (optional)</h1>
        <br />
...
export default CreateOffer_Policies_Benifits_Section;
