...
// Schema
export const CreateOffersValidationSchema = z.object({
      ...
      buyItems: z
        .array(
          z.object({
            ...
            selectedItems: z.array(z.object({ itemId: z.string() })).optional(),
          }),
        )
        .optional(),
      getItems: z
...
export type CreateOffersValidationSchemaType = z.infer<
  typeof CreateOffersValidationSchema
>;
